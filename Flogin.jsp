...
<html>
    ...
    <body>
        <%
            ...
            ps.setString(1, request.getParameter("a1"));
            ps.setString(2, request.getParameter("a2"));
             ...
             {
             %>
             <h1 style="background-color:lightcyan;color: white">Welcome to the Faculty page...</h1>
